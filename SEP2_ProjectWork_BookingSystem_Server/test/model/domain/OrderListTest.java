  ...
  private int randomNumber()
{
  ...
  private RoomInformation getRandomRoomInformation()
  {
    ...
    while (roomInformationList.getRoomInformationByIndex(index)==null)
    {
      index = randomNumber(this.roomInformationList.getSize());
    }
  ...
  {
    assertEquals(0,orderList.getSize());
    RoomInterface room = roomList.getRoomByIndex(randomNumber(roomList.getSize()));
    OrderInterface order = new Order(randomNumber(),room,roomInformationList.getRoomInformationByType(room.getType()),userList.getUserByIndex(randomNumber(userList.getSize())).getBasicInformation(),getRandomOptionServiceList(),getRandomTimeRangeList());
  ...
  @Test void addNewOrderMany()
  {
    ...
    for (int x=0;x<time;x++)
    {
      ...
      {
        order = new Order(randomNumber(),room,roomInformationList.getRoomInformationByType(room.getType()),userList.getUserByIndex(randomNumber(userList.getSize())).getBasicInformation(),getRandomOptionServiceList(),getRandomTimeRangeList());
      }
  ...
  @Test void addNewOrderBoundary()
  {
    ...
    OrderInterface order = new Order(randomNumber(),room,roomInformationList.getRoomInformationByType(room.getType()),userList.getUserByIndex(randomNumber(userList.getSize())).getBasicInformation(),getRandomOptionServiceList(),getRandomTimeRangeList());
    orderList.addNewOrder(order);
    RoomInterface otherRoom = roomList.getRoomByIndex(randomNumber(roomList.getSize()));
    OrderInterface otherOrder = new Order(order.getOrderNumber(),otherRoom,roomInformationList.getRoomInformationByType(otherRoom.getType()),userList.getUserByIndex(randomNumber(userList.getSize())).getBasicInformation(),getRandomOptionServiceList(),getRandomTimeRangeList());
  ...
  @Test void updateOrderOne()
  {
    ...
    RoomInterface room = roomList.getRoomByIndex(randomNumber(roomList.getSize()));
    OrderInterface newOrder = new Order(copy.getOrderNumber(),room,roomInformationList.getRoomInformationByType(room.getType()),userList.getUserByIndex(randomNumber(userList.getSize())).getBasicInformation(),getRandomOptionServiceList(),getRandomTimeRangeList());
  ...
  @Test void updateOrderBoundary()
  {
    ...
    RoomInterface room = roomList.getRoomByIndex(randomNumber(roomList.getSize()));
    OrderInterface newOrder = new Order(-1,room,roomInformationList.getRoomInformationByType(room.getType()),userList.getUserByIndex(randomNumber(userList.getSize())).getBasicInformation(),getRandomOptionServiceList(),getRandomTimeRangeList());
    orderList.updateOrder(newOrder);
    for (int x=0;x<orderList.getSize();x++)
    {
...
//
  ...
  @Test void cancelOrdersByUserOne()
  {
    ...
    int index = randomNumber(orderList.getSize());
    OrderInterface order = orderList.getOrderByIndex(index);
    UserInterface user = userList.getUserByEmail(order.getBasicInformation().getEmail());
  ...
  @Test void cancelOrdersByRoomOne()
  {
    ...
    int index = randomNumber(orderList.getSize());
    OrderInterface order = orderList.getOrderByIndex(index);
    RoomInterface room = roomList.getRoomByRoomNumber(order.getRoom().getRoomNumber());
