...
class RoomInformationListTest
{
  ...
  @Test void addNewRoomInformationBoundary()
  {
    ...
    RoomInformation otherRoomInformation = new RoomInformation(roomInformation.getType(),randomNumber(),getRandomOptionServiceList(),"Facilities " + randomNumber(),randomNumber());
